...
On first run, CmdBook automatically creates the required data directory and file.
...
The data directory is created automatically when the application is first launched.
